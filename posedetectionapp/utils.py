...
def output_keypoints_with_lines(POSE_PAIRS, frame):
    ...
    if (points[5] is not None) and (points[18] is not None) and (points[2] is not None):
        calculate_degree(point_1=points[5], point_2=points[18], point_3=points[1], point_4=points[8], frame=frame_line)
...
def calculate_degree(point_1, point_2, point_3, point_4, frame):
    # 역탄젠트 구하기
    dx1 = point_2[0] - point_1[0]
    dy1 = point_2[1] - point_1[1]
    dx2 = point_4[0] - point_3[0]
    dy2 = point_4[1] - point_3[1]
